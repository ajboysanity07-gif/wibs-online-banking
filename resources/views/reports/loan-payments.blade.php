...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .document-control-table td:last-child {
                padding-right: 0;
            }
    ...
    <body>
        ...
        <div class="certification page-break-avoid">
            ...
            <p class="certification-text">
                This is a system-generated Loan Payment Report prepared from the official loan payment records
                maintained by the organization for the account and reporting period stated above.
            </p>
        </div>

        <div class="document-control page-break-avoid">
            <div class="document-control-title">Document Control</div>
            <table class="document-control-table">
                <tr>
                    <td>
                        <span class="document-control-label">Generated on:</span>
                        {{ $formatDateTime($generatedAt) }}
                    </td>
                    <td>
                        <span class="document-control-label">Generated by:</span>
                        {{ $generatedBy ?? '--' }}
                    </td>
                </tr>
                <tr>
                    <td>
                        <span class="document-control-label">Report period:</span>
                        {{ $reportStart->format('Y/m/d') }} to {{ $reportEnd->format('Y/m/d') }}
                    </td>
                    <td>
                        <span class="document-control-label">Loan number:</span>
                        {{ $loanNumber }}
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <span class="document-control-label">Member account no:</span>
                        {{ $memberAccountNo ?? '--' }}
                    </td>
                </tr>
            </table>
        ...
        <div class="validation-notice page-break-avoid">
            <div class="validation-title">Validation Notice</div>
            <p class="validation-text">
                This document is electronically generated and is valid without handwritten signature, unless a
                separately signed copy is specifically required by office policy.
            </p>
        </div>

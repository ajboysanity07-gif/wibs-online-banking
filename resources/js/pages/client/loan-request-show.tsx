                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                        <div className="space-y-3">
                            ...
                            <p className="max-w-2xl text-sm text-muted-foreground">
                                Review the submitted snapshot of your loan
                                request, including the applicant and co-maker
                                details used for evaluation.
                            </p>
                        </div>
                    ...
                    <div className="space-y-6">
                        <Card className="border-border/30 bg-card/60 shadow-sm">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Key request information captured at
                                    submission.
                                </CardDescription>
                            </CardHeader>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                {canDownloadPdf ? (
                                    <Button asChild variant="outline">
                                        <a
                                            href={
                                                loanRequestPrint(loanRequest.id)
                                                    .url
                                            }
                                            target="_blank"
                                            rel="noreferrer"
                                ...
                                <p className="text-xs text-muted-foreground">
                                    PDFs include the exact snapshot submitted
                                    for review.
                                </p>
                            </CardContent>
                        </Card>

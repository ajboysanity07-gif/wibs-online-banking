...
class MemberApplicationProfile extends Model
{
    ...
    /**
     * The two top-level "health" section fields (LoanRequestDataService
     * FIELD_DEFINITIONS section 'health'), reused to pre-fill the loan
     * request wizard's health questionnaire step and written back on
     * validated loan submission. Submit-only, mirroring beneficiaryFields().
     * The health questionnaire is always about the applicant themselves
     * (unlike a co-maker), so -- like beneficiaryFields() -- there's exactly
     * one saved copy per profile, not a list to choose from.
     *
     * @return list<string>
     */
    public static function healthFields(): array
    {
        return [
            'health_smoking_status',
            'health_smoking_status_details',
    ...
    /**
     * GLAPI 17-item health questionnaire fields (LoanRequestDataService
     * FIELD_DEFINITIONS section 'health_glapi'), mirrors healthFields()/
     * beneficiaryFields() for pre-fill and submit-only write-back.
     *
     * @return list<string>
     */
    public static function healthGlapiFields(): array
    {
        return [
            'gl_health_q01_weight_change',
            'gl_health_q01_weight_change_details',
    ...
    protected function casts(): array
    {
        return [
            ...
            'health_hypertension' => 'boolean',
            'gl_health_q01_weight_change' => 'boolean',
            'gl_health_q02a_neuro' => 'boolean',
            'gl_health_q02b_respiratory' => 'boolean',
            'gl_health_q02c_cardiac' => 'boolean',
            'gl_health_q02d_digestive' => 'boolean',
            'gl_health_q02e_diabetes' => 'boolean',
            'gl_health_q02e_kidney' => 'boolean',
            'gl_health_q02e_liver' => 'boolean',
            'gl_health_q02e_urinary' => 'boolean',
            'gl_health_q02f_musculoskeletal' => 'boolean',
            'gl_health_q02g_oncology_blood' => 'boolean',
            'gl_health_q02h_dermatologic' => 'boolean',
            'gl_health_q02i_std_viral' => 'boolean',
            'gl_health_q02j_other_illness' => 'boolean',
            'gl_health_q04_prescribed_drugs' => 'boolean',
            'gl_health_q05_confinement_5yr' => 'boolean',
            'gl_health_q06_abnormal_labs' => 'boolean',
            'gl_health_q07_confinement_contemplated' => 'boolean',
            'gl_health_q08_blood_transfusion' => 'boolean',
            'gl_health_q09_other_disease' => 'boolean',
            'gl_health_q10_narcotics' => 'boolean',
            'gl_health_q12_alcohol' => 'boolean',
            'gl_health_q13_advised_stop' => 'boolean',
            'gl_health_q14_current_medication' => 'boolean',
            'gl_health_q15_pregnancy' => 'boolean',
            'gl_health_q16_relative_pep' => 'boolean',
            'gl_health_q17_pending_reinstatement' => 'boolean',
            'gl_health_q17_with_glapi' => 'boolean',
            'gl_health_q17_with_glapi_amount' => 'decimal:2',
            'gl_health_q17_with_other_companies' => 'boolean',
            'gl_health_q17_with_other_companies_amount' => 'decimal:2',
            'health_recent_hospitalization' => 'boolean',
            'applicant_pep_status' => 'boolean',
        ];
    }
}

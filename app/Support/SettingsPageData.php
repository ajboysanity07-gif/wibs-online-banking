    ...
    public static function fromRequest(Request $request, string $initialTab): array
    {
        ...
        $memberProfilePayload = $memberApplicationProfile
            ? [
                ...
                'sex' => $memberApplicationProfile->sex,
                ...
                'release_saved_account_id' => $memberApplicationProfile->release_saved_account_id,
                'payment_option' => $memberApplicationProfile->payment_option,
                'payment_saved_account_id' => $memberApplicationProfile->payment_saved_account_id,

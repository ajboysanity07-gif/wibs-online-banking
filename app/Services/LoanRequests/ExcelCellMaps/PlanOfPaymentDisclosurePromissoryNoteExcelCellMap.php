    ...
    public function cells(): array
    {
        return [
            0 => [
                ...
                $this->text('C42', 'reviewer.witness_one_name'),
                $this->text('C43', 'reviewer.witness_two_name'),
            ],
            1 => [
                $this->text('D9', 'applicant.full_name'),
                ...
                $this->text('B27', 'applicant.full_name'),
                $this->text('G27', 'reviewer.name'),
                $this->text('D41', 'applicant.full_name'),
                ...
                $this->text('B59', 'applicant.full_name'),
                $this->text('G59', 'reviewer.name'),
            ],
            2 => [
                $this->text('D7', 'applicant.full_name'),
                $this->text('C8', 'applicant.address'),
                ...
                $this->text('L50', 'reviewer.name'),
                $this->text('L52', 'reviewer.position'),
                $this->text('L57', 'applicant.full_name'),
            ...
            3 => [
                ...
                $this->text('B50', 'applicant.full_name'),
                $this->text('E50', 'co_maker_one.full_name'),
                $this->text('I50', 'co_maker_two.full_name'),
                $this->text('C53', 'applicant.address'),
                $this->text('E53', 'co_maker_one.address'),
                $this->text('I53', 'co_maker_two.address'),
                $this->text('B58', 'reviewer.witness_one_name'),
                $this->text('H58', 'reviewer.witness_two_name'),
            ],
        ];
    }

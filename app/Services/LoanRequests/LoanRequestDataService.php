...
class LoanRequestDataService
{
    ...
    private const FIELD_DEFINITIONS = [
        ...
        'dependent_extended_1_is_beneficiary' => [
            'label' => 'Extended family member 1 insurance beneficiary',
            'owner' => self::OWNER_MEMBER,
            'sensitive' => false,
            'required_on_submit' => false,
            'section' => 'dependents',
        ...
        'dependent_extended_2_is_beneficiary' => [
            'label' => 'Extended family member 2 insurance beneficiary',
            'owner' => self::OWNER_MEMBER,
            'sensitive' => false,
            'required_on_submit' => false,
            'section' => 'dependents',
        ...
        'dependent_extended_3_is_beneficiary' => [
            'label' => 'Extended family member 3 insurance beneficiary',
            'owner' => self::OWNER_MEMBER,
            'sensitive' => false,
            'required_on_submit' => false,
            'section' => 'dependents',
        ...
        'dependent_spouse_is_beneficiary' => [
            'label' => 'Spouse insurance beneficiary',
            'owner' => self::OWNER_MEMBER,
            'sensitive' => false,
            'required_on_submit' => false,
            'section' => 'dependents',

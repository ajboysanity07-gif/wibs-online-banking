...
class LoanRequestStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'insurance.beneficiary_primary_name' => [$insuranceRequired, 'nullable', 'string', 'max:255'],
            'insurance.beneficiary_primary_relationship' => [$insuranceRequired, 'nullable', 'string', 'max:255'],
            'insurance.beneficiary_primary_birthdate' => [$insuranceRequired, 'nullable', 'date', 'before:today', 'after:1900-01-01'],

...
class LoanRequestStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'insurance' => ['required', 'array:beneficiary_primary_name,beneficiary_primary_relationship,beneficiary_secondary_name,beneficiary_secondary_relationship'],
            ...
            'authorization' => ['required', 'array:authorized_recipient_name,authorized_recipient_relationship,authorized_recipient_contact'],
            ...
            'barangay' => ['required', 'array:barangay_name,barangay_clearance_reference'],

...
class LoanRequestProcessingUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'processing.signing_place' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.notarial_province' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.valid_id_number' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.valid_id_issued_at' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.doc_number' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.page_number' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.book_number' => ['sometimes', 'nullable', 'string', 'max:255'],
            'processing.series_year' => ['sometimes', 'nullable', 'string', 'max:255'],

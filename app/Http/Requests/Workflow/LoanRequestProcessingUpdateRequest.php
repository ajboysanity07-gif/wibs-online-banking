...
class LoanRequestProcessingUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'processing' => ['sometimes', 'array:service_charge_rate,insurance_rate,insurance_required,insurance_term,loan_security_rate,documentary_stamp_rate,notarial_fee,penalty_rate_per_month,authorization_required,barangay_required,security_required,loan_security_details,notarial_venue,witness_one_name,witness_two_name,barangay_official_name,barangay_official_title,guaranteed_net_take_home_pay'],
            ...
            'processing.insurance_required' => ['sometimes', 'boolean'],
            ...
            'processing.authorization_required' => ['sometimes', 'boolean'],
            'processing.barangay_required' => ['sometimes', 'boolean'],
            'processing.security_required' => ['sometimes', 'boolean'],
            'processing.loan_security_details' => ['sometimes', 'nullable', 'string', 'max:2000'],

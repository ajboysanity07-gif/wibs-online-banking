...
class RequestPreviewResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'assigned_officer' => $resource['assigned_officer'] ?? null,
            'assignment_state' => $resource['assignment_state'] ?? null,
            'can_claim' => (bool) ($resource['can_claim'] ?? false),
            'can_assign' => (bool) ($resource['can_assign'] ?? false),
            'can_reassign' => (bool) ($resource['can_reassign'] ?? false),
            'can_return_to_queue' => (bool) ($resource['can_return_to_queue'] ?? false),
